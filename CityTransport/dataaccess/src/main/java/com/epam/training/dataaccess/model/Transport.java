...
public class Transport extends AbstractObject implements Serializable{
	...
	public String toString() {
		return "Transport [id=" + id + ", registration_number=" + registrationNumber
				+ ", typeId=" + typeId + ", routeId=" + routeId + "]";
	}
